...
#define INVERT_ST_ENABLE_MASK (X_AXIS_BIT | Y_AXIS_BIT | Z_AXIS_BIT | A_AXIS_BIT | B_AXIS_BIT | C_AXIS_BIT) // Default disabled. Uncomment to enable.
...
#define ST_ROTATIONAL_MASK (A_AXIS_BIT | C_AXIS_BIT) // Default disabled. Uncomment and possibly remove axis bit(s) as needed to enable.
